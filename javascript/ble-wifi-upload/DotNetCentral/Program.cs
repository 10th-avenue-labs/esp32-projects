...
var serviceUuid = "12345600-1234-5678-1234-56789abcdef0";
...
string serializedInfo = JsonSerializer.Serialize(wifiInfo, serializationOptions);

// Convert the JSON string to a byte array
byte[] byteArray = System.Text.Encoding.UTF8.GetBytes(serializedInfo);

// Print the JSON string and byte array (for demonstration)
Console.WriteLine("JSON String: " + serializedInfo);
Console.WriteLine("Serialized byte array: " + BitConverter.ToString(byteArray));

// Write the wifi info to the characteristic 
await characteristic.WriteValueAsync(byteArray, new Dictionary<string, object>());
