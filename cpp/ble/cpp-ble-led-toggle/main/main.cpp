...
extern "C" void ble_store_config_init(void); // For some reason we need to manually declare this one? Not sure why as it lives in a library
    ...
    // Automation IO service
    {
        ...
        .characteristics =
            (struct ble_gatt_chr_def[]){// LED characteristic
                                        ...
                                        {0}}, // Characteristic array must be terminated in this way
    },
    { // Services array must be terminated in this way
        0, // No more services.
    }, 
};
...
extern "C" void app_main(){
    ...
    BleHost bleHost = BleHost();

    esp_err_t response = bleHost.initialize();
